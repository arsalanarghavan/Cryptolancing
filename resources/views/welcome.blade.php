<x-layout>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="info-item">
                                                ...
                                                <h4><a href="#">info@Cryptolancing.com</a></h4>
                                                <h4><a href="#">hr@Cryptolancing.com</a></h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="info-item">
                                                <i class="fa fa-map-marker"></i>
                                                <h4><a href="#">Technical and Vocational University of Iran,
                                                        Tehran, Iran</a></h4>
                                            </div>
                                        </div>
                                    </div>
    ...
    <footer>
        <div class="container">
            <div class="col-lg-12">
                <p>Copyright © 2023 <a href="#">Cryptolancing</a>. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
