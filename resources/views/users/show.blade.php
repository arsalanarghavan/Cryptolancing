            ...
            <div class="col">
                ...
                <div class="tab-content">
                    <div class="tab-pane active show row" id="filter-sellerProfile">
                        ...
                        <x-sectionTitle title="Jobs" desc="Work history on Cryptolancing"></x-sectionTitle>
                        @include('users.profile.projects')
                    </div>
                    <div class="row tab-pane" id="filter-buyerProfile">
                        <x-sectionTitle title="Projects Posted" desc="Work history on Cryptolancing"></x-sectionTitle>
